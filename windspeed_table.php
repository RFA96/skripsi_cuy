            ...
            <div class="content mt-3">
                <div class="animated fadeIn">
                    <div class="col-sm-6 col-lg-12">
                        <h3>Database Kecepatan Angin</h3><hr>
                    </div>
                    <div class="col-sm-6 col-lg-12">
                        <h5>Pilih tanggal:</h5>
                            ...
                            <div class="form-row align-items-center">
                                ...
                                <div class="col-sm-3 my-1">
                                    <select class="custom-select" name="tahun">
                                        <option>--- Tahun ---</option>
                                        <?php
                                        $q = $conn->query("SELECT DISTINCT substr(tanggal, 1, 4) AS tahun FROM wind;");
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                        ...
                                        $result = $conn->query("SELECT * FROM wind WHERE tanggal = '$komplit_tanggal'");
